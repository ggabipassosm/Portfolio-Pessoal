...
const translations = {
    en: {
        ...
        description: "Passionate about crafting elegant solutions, exploring data-driven insights, and building interfaces that matter. On a journey to become a skilled software engineer with a focus on front-end and data analysis, driven by international ambitions.",
        viewWork: "View my work",
        contactMe: "Contact me",
        aboutMe: "About Me",
        aboutMeSubtitle: "I am always seeking new challenges and opportunities to learn.",
        aboutMeParagraph1: "I am a Software Engineering student at the Federal University of Goiás, and I am building my career path by going beyond the classroom—participating in academic projects, a junior enterprise, teaching assistant roles, and undergraduate research.",
        aboutMeParagraph2: "I am currently seeking an IT internship opportunity to continue learning, contribute to real-world projects, and grow professionally.",
        currentlyDeepDivingInto: "Currently deep-diving into:",
        keyMilestones: "Key Milestones",
        teachingAssistantTitle: "Teaching Assistant for Data Analysis and Communication",
        teachingAssistantDesc: "Scholarship-holding teaching assistant for the Data Analysis and Communication module at the Federal University of Goiás.",
        level5Title: "Member of the Level5 project team",
        level5Desc: "Worked on the projects team at Level5, the junior enterprise of the Federal University of Goiás.",
        softwareEngineeringTitle: "Started Software Engineering degree",
        softwareEngineeringDesc: "Bachelor's degree in Software Engineering from the Federal University of Goiás (UFG)",
    ...
    pt: {
        ...
        description: "Apaixonada por criar soluções elegantes, explorar insights baseados em dados e desenvolver interfaces que fazem a diferença. Construindo minha trajetória como engenheira de software, com foco em front-end e análise de dados, com ambições internacionais.",
        viewWork: "Ver meus projetos",
        contactMe: "Entre em contato",
        aboutMe: "Sobre mim",
        aboutMeSubtitle: "Estou sempre em busca de novos desafios e oportunidades para aprender.",
        aboutMeParagraph1: "Sou estudante de Engenharia de Software na Universidade Federal de Goiás, construindo minha trajetória profissional ao ir além da sala de aula — participando de projetos acadêmicos, empresa júnior, monitoria e projeto de Iniciação Científica.",
        aboutMeParagraph2: "Atualmente, estou em busca de uma oportunidade de estágio em TI para continuar aprendendo, contribuir com projetos reais e crescer profissionalmente.",
        ...
        teachingAssistantDesc: "Monitoria com bolsa de estudos na disciplina de Análise de Dados e Comunicação na Universidade Federal de Goiás.",
        level5Title: "Membro da equipe de projetos da Level5",
        level5Desc: "Atuei na equipe de projetos da Level5, empresa júnior da Universidade Federal de Goiás.",
        softwareEngineeringTitle: "Início do curso de Engenharia de Software",
        softwareEngineeringDesc: "Graduação em Engenharia de Software pela Universidade Federal de Goiás (UFG)",
...
function updateContactLink(language) {
    ...
    contactLink.href =
        `https://mail.google.com/mail/?view=cm&fs=1&to=ggabrielapassos.eng@gmail.com&subject=${subject}&body=${body}`;
}
